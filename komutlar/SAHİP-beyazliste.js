...
message.channel.send("<a:781157554973704214:833983183295873064> **"+cuser.tag+"** kullanıcısı başarıyla karalisteden çıkarıldı.")
const westra = new Discord.MessageEmbed()
.setColor("#GREEN")
.setTimestamp()
.setDescription(`<a:781157554973704214:833983183295873064> **${cuser.tag}** kullanıcısı karalisteden çıkarıldı.`)
  cclient.channels.cache.get("836036177281679370").send(westra)
cdb.delete(`ckaraliste.${cuser.id}`)
