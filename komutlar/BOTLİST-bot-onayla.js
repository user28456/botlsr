 ...
 let westrabotlistyetkilisi = db.fetch(`westrabotlistyetkilirol_${message.guild.id}`)
  ...
  message.delete()
   const westrabumbeyyyy = new Discord.MessageEmbed()
    ...
    .setTimestamp()
    .setDescription(`<a:781157554973704214:833983183295873064> <@${sahip}> adlı kişinin <@${botisim}> adlı botu onaylandı. \nOnaylayan yetkili:
    ${message.author}`)
		client.channels.cache.get(log).send(westrabumbeyyyy);
		message.channel.send(`<a:781157554973704214:833983183295873064> Botu onayladınız.`).then(x => x.delete({timeout: 3000}))
};
