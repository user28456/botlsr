...
if(message.author.id != "493003491560783872") return message.channel.send(bakim)
  ...
  let kanal = message.mentions.channels.first();
    if (!kanal) {
      message.channel.send(`<a:781157570785443851:833983185377296384>  Bir kanal etiketlemelisin!`);
      return;
    }
 db.set(`westrabasvurugidecekkanal_${message.guild.id}`, kanal.id);
  message.channel.send(`<a:781157554973704214:833983183295873064> Başvuru gidecek kanal başarıyla ${kanal} olarak ayarlandı!`)
}
